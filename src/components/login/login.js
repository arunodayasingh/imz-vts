...
import wtanker from "../../assests/wtanker.jpg";
                ...
                <Grid className="container">
                    <Grid className="row">
                            <Grid className="col-lg-12 col-xl-10 mx-auto">
                                <img src={logo2} style={{maxHeight:"100px",maxWidth:"200px", marginTop:"-180px", marginBottom:"30px",marginLeft:"75px"}}alt="logo"/>
                            </Grid>
                        <Grid className="col-lg-12 col-xl-10 mx-auto">
                            ...
                            <form>
                                ...
                                <Button type="submit" style={{marginLeft:"100px"}} variant='contained' className="text-uppercase mb-2 rounded-pill shadow-sm px-4">Log in</Button>
